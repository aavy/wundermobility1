...
function submitForm() {
				...
				storeLocalBrowser(obj);
				sendAccountInfo(obj);
}

function sendAccountInfo(obj){

				var iban = Object.keys(obj)[8];
				...
				var jsonValue = JSON.stringify(dataToSend);
						$.ajax({
							type: "POST",
...
function storeLocalBrowser(obj){
				const input = document.getElementById('regForm');
